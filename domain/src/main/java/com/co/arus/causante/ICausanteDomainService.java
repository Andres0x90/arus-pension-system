...
public interface ICausanteDomainService {
    ...
    CausanteCreado crearCausante(Documento documento, Nombre nombre, Date fechaNacimiento, Genero genero, IBeneficiarioFactory beneficiarioFactory, IRentaFactory rentaFactory);
