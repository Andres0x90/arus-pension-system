...
public class RegistrarCausanteUseCase extends CommandUseCase<Documento> implements RegistrarCausantePort {
    ...
    public RegistrarCausanteUseCase(MessagePublisher messagePublisher, EventStorage<Documento> eventStorage, ICausanteDomainService causanteDomainService, Mapper mapper) {
